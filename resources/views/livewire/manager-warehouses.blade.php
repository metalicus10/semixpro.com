    ...
    <div class="p-4 bg-white dark:bg-gray-900 shadow-md rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-8">
                ...
                <!-- Список складов -->
                <div x-data="{ deleteWarehouseId: null, showDeleteModal: false }"
                    ...
                    <div x-show="showDeleteModal" x-transition
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-sm w-full">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-6">This will delete the selected warehouse and
                                cannot be undone.</p>

                            <div class="flex justify-end space-x-4">
                                <button @click="showDeleteModal = false; deleteWarehouseId = null;"
                                        class="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 dark:bg-gray-700 dark:text-gray-300">
                                    Cancel
                                </button>
                                <button
                                    @click="$wire.deleteWarehouse(deleteWarehouseId).then(() => { showDeleteModal = false; deleteWarehouseId = null; })"
                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        ...
                        <ul class="py-1 text-sm">
                            @foreach ($parts as $part)
                                <template
                                    x-if="!search || '{{ strtolower($part->name) }}'.includes(search.toLowerCase())">
