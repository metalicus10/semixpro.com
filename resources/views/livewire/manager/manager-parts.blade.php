        ...
        <div class="flex flex-row space-x-4">
            ...
            @endscript
                <div class="relative overflow-hidden">
                        ...
                        <!-- Таб заголовки -->
                        <ul id="draggable-tabs" class="flex flex-nowrap no-scrollbar text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400"
                            x-ref="tabContainer"
                            @scroll="checkScroll"
                                ...
                                >
                                    ...
                                    <div x-show="editingTabId === tab.id" class="relative">
                                        ...
                                        <div class="absolute top-2 right-2">
                                            <button @click="saveEdit(tab)" class="bg-green-500 text-white p-1 rounded hover:bg-green-600">✓</button>
                                            <button @click="cancelEdit" class="bg-red-500 text-white p-1 rounded hover:bg-red-600">✗</button>
                                        </div>
                                    </div>
                                                        ...
                                                        <div x-data="{ isUploading: false, uploadProgress: 0 }"
                                                            ...
                                                            <div class="flex flex-row">
                                                                <span class="w-[56px] h-[56px]">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="56"
                                                                        height="56" viewBox="0 0 256 256" xml:space="preserve">
                                                                        <defs>
                                                                        </defs>
                                                            ...
                                                            @endif
                                                                <div x-data="{ showTooltip: false }" @mouseenter="showTooltip = true" @mouseleave="showTooltip = false"
                                                                    ...
                                                                    <div for="upload-image-{{ $part->id }}" wire:click="openImageModal({{ $part->id }})"
                                                                        class="text-white rounded-full p-1 cursor-pointer h-[20px]">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="h-4 w-4" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
                                                                            <defs>
                                                                            </defs>
