<div x-data="viewportPanel()" x-ref="panel"
    ...
    <div class="p-1 md:p-4 bg-white dark:bg-gray-900 shadow-md rounded-lg overflow-hidden">
            ...
            <div class="flex">
                ...
                <span
                    ...
                    <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                         xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M18 10a8 8 0 1 0-9.6 7.88.75.75 0 1 0 .2-1.48A6.5 6.5 0 1 1 10 16a.75.75 0 0 0-.75-.75h-.5a.75.75 0 0 0 0 1.5h.075A8.001 8.001 0 0 0 18 10Zm-6 0a.75.75 0 0 0-1.5 0 .75.75 0 0 0 1.5 0ZM10 7.25A2.75 2.75 0 1 0 12.75 10a.75.75 0 0 0 1.5 0A4.25 4.25 0 1 1 10 5.75a.75.75 0 0 0 0 1.5Z"/>
                    </svg>
                </span>
        ...
        <button data-modal-target="confirmDeletion" data-modal-toggle="confirmDeletion"
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <form wire:submit.prevent="deleteUser">
                            ...
                            <div class="mt-6 flex justify-end">
                                <button wire:click="$set('showDeleteModal', false)" data-modal-hide="confirmDeletion"
                                        type="button"
                                        class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                    {{ __("No, cancel") }}
                                </button>
                                <button type='submit' wire:click="$set('showDeleteModal', false)"
                                        data-modal-hide="confirmDeletion" type="button"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                    {{ __("Yes, I'm sure") }}
                                </button>
                            </div>
