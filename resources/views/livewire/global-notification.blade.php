<div x-data="{
    ...
    <button @click="open = !open" class="relative flex justify-center items-center w-[24px] h-[24px]">
    ...
    <!-- Слайд уведомлений -->
    <div
        class="fixed right-0 top-[65px] h-[calc(90vh-64px)] w-full sm:w-96 mr-2.5 bg-white border-1 border-green-500 rounded-l-2xl rounded-r-lg
        dark:bg-gray-900 shadow-lg z-50 transform transition-transform duration-300 ease-in-out"
        x-show="open"
