        ...
        stopScan() {
            ...
            <div class="flex items-center justify-between gap-4 w-full">
                ...
                <div class="relative w-full max-w-3xl">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center px-3">
                        <button @click="startScan"
                                class="flex items-center gap-1 text-green-400 outline-1 rounded outline-gray-700 hover:text-white hover:bg-[#28282ba3] focus:outline-gray-700 transition cursor-pointer">
                            @include('icons.scan')
                    ...
                    <div x-show="scanning" @click.away="scanning = false;"
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <button
                        class="p-3 hover:bg-accent text-white text-accent-foreground! hover:text-accent-foreground transition-colors duration-200 rounded-md bg-gray-800 text-sm font-medium ring-offset-background cursor-pointer">@include('icons.menu')</button>
                    <button @click="showAddSupplierModal = true"
                            class="px-4 py-2 bg-brand-accent text-white rounded-md hover:bg-green-600 cursor-pointer">
                        Add Supplier
                    </button>
                </div>
                    ...
                    <div class="bg-gray-800 rounded-xl p-4 text-white flex flex-col gap-2">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center font-bold text-sm overflow-hidden">
                        ...
                        {{-- Нижняя часть --}}
                        <div
                            class="flex justify-between items-center text-sm text-gray-300 pt-2 border-t border-gray-700 mt-2">
                            ...
                            <div>
                                <span
                                    :class="supplier.active ? 'bg-blue-600 text-white px-2 py-1 rounded' : 'bg-gray-600 text-gray-300 px-2 py-1 rounded'"
                                    x-text="supplier.active ? 'Active' : 'Inactive'"></span>
                            </div>
                        </div>
        ...
        <div x-show="showDeleteConfirmModal" class="fixed inset-0 flex items-center justify-center">
            ...
            <div class="bg-white p-6 rounded shadow-lg z-50">
                ...
                <div class="flex justify-end space-x-2">
                    <button @click="showDeleteConfirmModal = false" class="px-4 py-2 bg-gray-300 rounded">Cancel
                    </button>
        ...
        >
            <div class="bg-white rounded-lg shadow-lg w-full max-w-xl p-6 relative"
                ...
                <div class="grid grid-cols-1 gap-3">
                    <input type="text" x-model="supplier.name" placeholder="Supplier Name"
                           class="input input-bordered w-full">
                    <input type="text" x-model="supplier.contact_name" placeholder="Contact Name"
                           class="input input-bordered w-full">
                    <input type="email" x-model="supplier.email" placeholder="Email"
                           class="input input-bordered w-full">
                    <input type="tel" x-model="supplier.phone" placeholder="Phone" class="input input-bordered w-full">
                    <input type="text" x-model="supplier.address" placeholder="Address"
                           class="input input-bordered w-full">
