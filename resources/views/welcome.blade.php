    ...
    <main>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div class="text-center max-w-4xl mx-auto mb-16">
                    ...
                    <p class="text-xl text-brand-light mb-10 max-w-160 mx-auto leading-none">
                        Современное решение для управления номенклатурой, складами и запчастями. Прозрачный учет, гибкие
                        настройки доступа.
                    </p>
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <button
                            class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-11 rounded-md px-8 bg-brand-accent hover:bg-brand-accent/90 text-brand-darker">
                            Начать Работу
                        </button>
                        <button
                            ...
                            <div class="w-full h-auto bg-card/50">
                                <div class="p-6 text-left">
                                    <div class="flex items-center justify-between mb-6">
                                        ...
                                        <div
                                            class="text-xs text-muted-foreground flex flex-col xl:flex-row items-center">
                                            Обновлено:
                                    ...
                                    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6">
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-between items-center text-xs mt-1"><span
                                                    class="text-brand-light/70">6 активных</span>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center text-xs"><span
                                                    class="text-brand-dark">+142</span>
                                        ...
                                        <div class="space-y-3">
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div><p class="font-medium text-brand-light">Добавлена запчасть:
                                                            Датчик ABX-12</p>
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div><p class="font-medium text-brand-light">Создан новый склад:
                                                            Южный</p>
        ...
        <section class="py-16 bg-secondary/30">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <p class="text-center text-muted-foreground text-sm uppercase tracking-wider font-medium mb-8">Our
                    Recent Clients &amp; Partners</p>
                <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 items-center justify-items-center">
                    <div
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-4">
                                <div
                                    class="w-12 h-12 bg-brand-accent/20 rounded-lg flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <h3 class="font-semibold mb-1 leading-tight">Оборачиваемость запасов</h3>
                                    <p class="text-sm text-gray-400">Анализ скорости движения товаров на складе</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                <div
                                ...
                                <div>
                                    <h3 class="font-semibold mb-1 leading-tight">Прогнозирование спроса</h3>
                                    <p class="text-sm text-gray-400">Автоматическое прогнозирование потребности в
                                        товарах</p>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Pricing Plans -->
        <section id="pricing" class="pt-24 pb-12 lg:py-24">
            <div class="container mx-auto px-4 md:px-6">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2 class="text-3xl font-bold tracking-tight mb-4">Выберите тариф для эффективного <br>
                        <span class="text-primary">управления вашим складом</span>
                    </h2>
                    <p class="text-muted-foreground">Подберите тариф, который соответствует вашим потребностям. Все
                        тарифы включают 14-дневный пробный период.</p>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <div
                        ...
                        <div class="flex flex-col space-y-1.5 p-6 pb-4"><h3 class="text-xl font-semibold mb-1">Базовый
                                тариф</h3>
                            <p class="text-muted-foreground text-sm mb-4">Для небольших складов с минимальной
                                номенклатурой</p>
                            <div class="flex items-end">
                                <span class="text-4xl font-bold">0 $</span><span class="text-muted-foreground ml-2">/месяц</span>
                            </div>
                        </div>
                        <div class="p-6 pt-0">
                    ...
                    <div
                        ...
                        <div class="flex flex-col space-y-1.5 p-6 pb-4"><h3 class="text-xl font-semibold mb-1">
                                Профессиональный</h3>
                            <p class="text-muted-foreground text-sm mb-4">Для активного управления складскими
                                запасами</p>
                            <div class="flex items-end">
                                <span class="text-4xl font-bold">19.99 $</span>
                                <span class="text-muted-foreground ml-2">/месяц</span>
                            </div>
                        </div>
                        <div class="p-6 pt-0">
                            <ul class="space-y-3 mb-8">
                    ...
                    <div
                        ...
                        <div class="flex flex-col space-y-1.5 p-6 pb-4">
                            <h3 class="text-xl font-semibold mb-1">Корпоративный</h3>
        ...
        <section class="py-20 px-4 bg-white/5">
            <div class="container mx-auto">
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                    <div>
                        <div class="text-4xl font-bold text-brand-accent mb-2">22+</div>
                        <div class="text-gray-400">Года на рынке</div>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-brand-accent mb-2">76K+</div>
                        <div class="text-gray-400">Клиентов</div>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-brand-accent mb-2">5.2M</div>
                        <div class="text-gray-400">Операций в день</div>
                    </div>
                    <div>
                        <div class="text-4xl font-bold text-brand-accent mb-2">35.8M+</div>
            ...
            <div
                ...
                <div
                    class="text-center max-w-3xl mx-auto mb-16"><h2
                        class="text-3xl font-bold tracking-tight mb-4">Начните управлять <br><span
                            class="text-primary">вашими складами</span></h2>
                    <p
                        class="text-muted-foreground">Свяжитесь с нами для получения дополнительной информации или
                        начала
                ...
                <div
                    ...
                    <form class="space-y-6">
                        ...
                        <div class="space-y-2"><label
                                class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                for=":r5:-form-item">Сообщение</label>
                            <textarea
                                ...
                                name="message" id=":r5:-form-item" aria-describedby=":r5:-form-item-description"
                                aria-invalid="false">
                            </textarea>
                        </div>
                        <div class="flex justify-center">
                            <button
                                class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 glow-effect undefined"
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div class="w-full">
                    ...
                    <p class="text-gray-400">SemixPro - современная система управления складами, запчастями и
                        номенклатурой.
                        Оптимизируйте ваши складские операции с нашими мощными инструментами.</p>
                    <div class="flex space-x-4 mt-2">
                        <a href="#" class="text-muted-foreground hover:text-brand-accent transition-colors">
