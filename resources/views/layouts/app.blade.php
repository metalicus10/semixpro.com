...
<div x-data="() => ({
    ...
    <nav
        ...
        <div class="flex items-center justify-between py-3 px-6 lg:px-5 lg:pl-3">
            ...
            <nav class="flex items-center space-x-1 absolute left-1/2 transform -translate-x-1/2 dark:text-brand-light">
                <a href="/dashboard">
                    <button class="justify-center text-sm font-medium ring-offset-background transition-colors
                    focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2
                    disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-9 rounded-md
    ...
    <aside id="logo-sidebar" :class="{'translate-x-0': showSidebar, '-translate-x-full': !showSidebar}"
           class="fixed left-0 z-40 w-64 h-screen transition-transform -translate-x-full border-r border-gray-200 sm:translate-x-0 dark:bg-brand-background dark:border-gray-700"
           aria-label="Sidebar">
